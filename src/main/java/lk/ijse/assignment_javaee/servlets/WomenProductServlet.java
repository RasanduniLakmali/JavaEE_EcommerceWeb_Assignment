...
@WebServlet(name = "WomenProductServlet",value = "/women-product")
public class WomenProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        List<ProductDTO> productList = productBO.getWomenProducts(req);
        ...
        req.getRequestDispatcher("women's_products.jsp").forward(req, resp);
    }
}
